...
const CoinChart = ({ symbol, selectedPeriod, setSelectedPeriod, priceHistory, historyLoading }) => {
  const periodOptions = [
    { day: 1, label: "1G" },
    { day: 7, label: "7G" },
    { day: 30, label: "1A" },
  ...
  return (
    <div className="detail-box">
      ...
      {historyLoading ? (
        ...
        <PriceChart symbol={symbol} priceHistory={priceHistory} days={selectedPeriod} />
      )}
    </div>
  );
};
