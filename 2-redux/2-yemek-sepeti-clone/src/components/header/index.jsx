...
const Header = () => {
  // store'daki restoran verisine abone ol
  const { restaurants } = useSelector((store) => store.restaurantReducer);

  // store'daki cart verisine abone ol
    ...
    <header className="sticky top-0 z-20 pb-3 pt-4 backdrop-blur">
      <div className="container">
        <div className="box flex flex-wrap items-center justify-between gap-5 px-5 py-4">
          <Link to="/" className="font-sr text-2xl lg:text-3xl text-red-500 font-bold tracking-tight drop-shadow-sm">
            Yemek Sepeti
          </Link>
