...
const Card = ({ item }) => {
  return (
    ...
    >
      <span className="pill absolute right-4 top-4 bg-white/90 shadow-lg">{item.distance} km</span>

      <img src={item.photo} alt={item.name} className="w-full object-cover h-57.5 lg:h-50 rounded-3xl" />
