  ...
  return (
    <div className="wrapper">
      <form onSubmit={handleSubmit} className="box flex flex-col gap-10 text-center">
        ...
        <p>
          Selam <span className="font-semibold">{user.displayName}</span>, <br /> Hangi Odaya Gireceksin?
        </p>
        ...
        <button type="button" className="btn bg-red-500 text-white" onClick={handleSignOut}>
          Çıkış Yap
        </button>
      </form>
    </div>
