    ...
    <div className="flex justify-between">
      <div className="text-tw-blue text-xl flex gap-4">
        <label htmlFor="file" type="button" className="form-icon">
          <Image />
          <input id="file" type="file" name="media" className="hidden" onChange={handleMediaChange} />
        </label>
      ...
      <button disabled={isLoading || mediaType === "not-supported"} type="submit" className="submit-button">
