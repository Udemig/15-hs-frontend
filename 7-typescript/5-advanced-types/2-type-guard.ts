...
// not: typeof kendi oluşturduğumuz tipleri kontrol edemez
type Tur = { isim: string; zorluk: string };

const tur: Tur = { isim: "Doğa Yürüyüşü", zorluk: "zor" };
...
const handleError = (error: NetworkError | ValidationError | Error) => {
