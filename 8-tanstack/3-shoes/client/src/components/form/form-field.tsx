...
const FormField: FC<Props> = ({ label, name, type = "text", required = true, options }) => {
  return (
    <div className="relative">
      ...
      <div>
        ...
        <ErrorMessage component="div" name={name} className="absolute -bottom-5 lef-t text-red-500 text-sm" />
      </div>
    </div>
  );
};
