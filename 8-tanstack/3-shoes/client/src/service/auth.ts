...
import type { LoginFormValues, RegisterFormValues, Response, User } from "../types";
import api from "./api";
...
// çıkış yapma anında kullanıcağımız mutasyon
...
// kullanıcı profil verisini almak için hook
