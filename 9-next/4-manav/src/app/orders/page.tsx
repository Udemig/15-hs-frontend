  ...
  return (
    <div className="page">
      ...
      <div className="space-y-4">
        {orders.map((order) => (
          <div key={order._id} className="bg-white border border-gray-200 shadow-md overflow-hidden rounded-lg">
            <div className="p-6">
              {/* Ürün Listesi */}
                ...
                {order.items.map((item, key) => (
                  <div key={key} className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="size-16 relative rounded-lg overflow-hidden border border-gray-200 shadow-md">
                        <Image src={item.product.photo} alt={item.product.name} width={64} height={64} />
                      </div>
                    ...
                    <p className="font-medium text-gray-800">{item.quantity * item.price} ₺</p>
                  </div>
                ))}
              </div>
